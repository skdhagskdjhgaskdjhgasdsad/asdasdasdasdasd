...
classifier = ml5.imageClassifier('https://storage.googleapis.com/tm-model/5mxzZHkpx/model.json')
...
function speak() {
    ...
    speak_data_1 = "the first predictyion is" + prediction_1;
    speak_data_2 = "the secent  predictyion is" + prediction_2;
